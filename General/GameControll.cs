...
public class GameControll : MonoBehaviour {
    ...
    public void ShowTip(int itemId, int type)
    {
        ...
        if (type == 0)
        {
            ...
            m_TipText.text = "You need " + inventory.m_itemsDatabase.Items[itemId].name;
        ...
        {
            m_TipText.gameObject.SetActive(true);
            m_TipText.text = "You need to find all the papers before leaving!";
            StartCoroutine(WaitForTip());
        }
        ...
        {
            m_TipText.gameObject.SetActive(true);
            m_TipText.text = "Use " + inventory.m_itemsDatabase.Items[itemId].name;
            StartCoroutine(WaitForTip());
        }
        ...
        {
            m_TipText.gameObject.SetActive(true);
            m_TipText.text = "You picked up " + inventory.m_itemsDatabase.Items[itemId].name;
            StartCoroutine(WaitForTip());
        }
    }
